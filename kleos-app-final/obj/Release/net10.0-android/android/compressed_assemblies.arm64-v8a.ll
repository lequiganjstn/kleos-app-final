...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [142 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13256960; uint32_t buffer_offset
	}, ; 139: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13427968; uint32_t buffer_offset
	}, ; 140: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2321408, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13450528; uint32_t buffer_offset
	} ; 141: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15771936, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15771936 x i8] zeroinitializer, align 1
